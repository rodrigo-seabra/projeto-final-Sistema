...
namespace LookingThings.Controllers
{
    public class ObservacoesController : Controller
    {
        ...
        {
            var contexto = _context.Observacoes.Include(o => o.Objeto).Include(o => o.Usuario);
        ...
        {
            ViewData["ObjetoId"] = new SelectList(_context.Objeto, "ObjetoId", "ObjetoNome");
        ...
        public async Task<IActionResult> Create([Bind("ObservacoesId,ObservacoesDescricao,ObservacoesData,UsuarioId,ObjetoId")] Observacoes observacoes)
        {
            ...
            ViewData["ObjetoId"] = new SelectList(_context.Objeto, "ObjetoId", "ObjetoNome", observacoes.ObjetoId);
