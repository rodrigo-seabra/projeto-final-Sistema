...
namespace LookingThings.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,UsuarioNome,UsuarioEmail,UsuarioTelefone,UsuarioSenha")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioId,UsuarioNome,UsuarioEmail,UsuarioTelefone,UsuarioSenha")] Usuario usuario)
        {
